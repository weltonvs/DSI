...
\begin{table}[H]
	...
	\resizebox{17.5cm}{!}{
	  \begin{tabular}{|l|l|l|} 
		...
		Heurístico, sentido común & \multicolumn{1}{p{1.0cm}|}{Si} & \multicolumn{1}{p{13.0cm}|}{Si, no es fácil de transferir}\\
		\hline

		\multicolumn{1}{|p{6.0cm}|}{Altamente especializado, específico del dominio} & \multicolumn{1}{p{1.0cm}|}{Si} & \multicolumn{1}{p{13.0cm}|}{Si, se necesita conocimientos del dominio}\\
		\hline

		Basado en la experiencia & \multicolumn{1}{p{1.0cm}|}{Si} & \multicolumn{1}{p{13.0cm}|}{Si, hay una dependencia enorme del experto}\\
		\hline
		...
		Incierto, puede ser incorrecto & \multicolumn{1}{p{1.0cm}|}{Si} & \multicolumn{1}{p{13.0cm}|}{Si, pero es impredicible}\\
		\hline

		Cambia con rapidez & \multicolumn{1}{p{1.0cm}|}{Si} & \multicolumn{1}{p{13.0cm}|}{Si, pero no se puede mejorar}\\
		\hline

		Dificil de verificar & \multicolumn{1}{p{1.0cm}|}{Si} & \multicolumn{1}{p{13.0cm}|}{Si, no se le puede hacer nada}\\
		\hline
		...
		Papel & \multicolumn{1}{p{1.0cm}|}{No} & \multicolumn{1}{p{13.0cm}|}{}\\
		\hline
...
\begin{table}[H]
	...
	\resizebox{16.0cm}{!}{
	  \begin{tabular}{|l|l|} 
		...
		\textbf{Modelo de Tareas} & \textbf{Formulario TM-1: Análisis de Tareas}\\ 
		\hline\hline
		\textsc{Nombre} & \multicolumn{1}{p{15.0cm}|}{Tarea 5 - Gestionar las operativas abiertas} \\
		\hline
