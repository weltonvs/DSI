...
\begin{table}[H]
  ...
  \resizebox{17,5cm}{!}{
    \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      \hline
      1 & Introducir datos gestión & \multicolumn{1}{|p{6.0cm}|}{\centering Usuario de Especulador Experto} & En el PC del Usuario & \multicolumn{1}{|p{6.0cm}|}{\centering Experiencia por parte del usuario} & Sí (moderado) & Alta \\
      \hline
      2 & Operación Comprar & \multicolumn{1}{|p{6.0cm}|}{\centering Software Especulador Experto (con su sistema inteligente de predicción)}& En PC del usuario & Experiencia de compra de activos & Sí (elevado) & Máxima \\
      \hline
      3 & Operación Vender & \multicolumn{1}{|p{6.0cm}|}{\centering Software Especulador Experto (con su sistema inteligente de predicción)} & En PC del usuario & Experiencia de venda de activos & Sí (elevado) & Máxima \\
      \hline
      4 & \multicolumn{1}{|p{6.0cm}|}{\centering Prueba mediante simulación de inversión} & \multicolumn{1}{|p{6.0cm}|}{\centering Dept. de prubas con el Especulador Experto} & En el laboratorio de pruebas & No & No & Alta \\
      \hline
    \end{tabular}
  }
